...
#define CUBE_JUMP_HEIGHT 2.1675 * BLOCKS_TO_VALUE
#define CUBE_JUMP_SPEED sqrt(2 * CUBE_GRAVITY * CUBE_JUMP_HEIGHT)

#define CUBE_YELLOW_ORB_MAX_HEIGHT 2.1675 * BLOCKS_TO_VALUE
...
#define CUBE_MINI_YELLOW_ORB_JUMP_SPEED CUBE_MINI_JUMP_SPEED
...
#define UFO_GRAVITY_RAISING 0x46a5
#define UFO_GRAVITY_FALLING 0x2f19

...
@echo off
py export_levels.py stereomadness backontrack polargeist dryout baseafterbase cantletgo jumper timemachine cycles xstep clutterfunk theoryofeverything electromanadventures clubstep electrodynamix leveleasy dorabaebasic4 dorabaebasic7 groundtospace ultimatedestruction thenightmare rose problematic deathmoon everyend test test2
pause